...
export class ListboxComponent implements OnInit {
  ...
  data = [
    ...
    },
    {
      ...
      "model": "Neon",
      "make": "Chrysler",
      "preview": " This car is sold as the Dodge Neon in the United States and as Chrysler Neon for export only. It is a second generation Neon produced since 2000. There is a choice of three petrol engines. The basic 1.6-liter petrol is the same unit found on the MINI. The top of the range is a 2.0-liter engine, providing 133 hp, besides acceleration is a weak point of all Neons.",
      "description": "/assets/img/car4.png",
      "price": 85400
    }
  ];
